# Generated by Django 3.0.7 on 2020-07-11 07:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='metadata.Track')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rank.GameUser')),
                ('kart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='metadata.Kart')),
            ],
            options={
                'db_table': 'user_kart',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rank.GameUser')),
                ('speed_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rank.SpeedType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_id', to='rank.GameUser')),
                ('to_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_id', to='rank.GameUser')),
            ],
            options={
                'db_table': 'comments',
            },
